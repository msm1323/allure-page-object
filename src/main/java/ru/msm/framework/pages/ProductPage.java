...
//        product = new Product(n, pr, types, m, p, checks.indexOf(g.get(0)));
    ...
    @Step("Поменять гарантию товара на гарантию с кол-вом месяцев = \"{m}\"")
    ...
    @Step("Покупка/Добавление в корзину товара")
    ...
    @Step("Проверка на соответствие цены корзины в лейбле верхней панели сайта " +
            "с действительной суммой покупок на данный момент")
    public ProductPage checkCurrentTotalPrice() {
//        Allure.getLifecycle().addAttachment("Screenshot!!!", "image/png",
//                "png", ((TakesScreenshot) DRIVER_MANAGER.getDriver()).getScreenshotAs(OutputType.BYTES));
