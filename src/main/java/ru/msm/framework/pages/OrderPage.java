...
public class OrderPage extends BasePage {
    ...
    public static void addProductToOrder(Product product) {
        ...
        System.out.println("currentTotalPrice = "+currentTotalPrice);
    }

    @Step("Проверка соответствия гарантии товара {name} нужной по введенному кол-ву месяцев - {m}")
    ...
    @Step("Проверка на соответствие отображающихся в корзине цен товаров действительным ценам этих товаров")
    ...
    @Step("Проверка на соответствие цены корзины с действительной суммой покупок на данный момент")
...
//        action.moveToElement(removeProduct).click();
    ...
    @Step("Проверка корректности удаления товара {name}")
    ...
    //прописать условие в описание шага?
    @Step("Изменение кол-ва товара {name} на {n} в корзине")
    ...
    @Step("Возвращение в корзину последнего удаленного товара")
    ...
    @Step("Проверка корректности возврата последнего удаленного товара в корзину")
